...
class P2PAgentPage extends StatefulWidget {
  // const P2pTadingPage({Key? key}) : super(key: key);

  @override
  State<P2PAgentPage> createState() => _P2PAgentPageState();
}

class _P2PAgentPageState extends State<P2PAgentPage> {
        ...
        child: ListView(
            children: [
              ...
              Center(
                child: Material(
                  ...
                  child: Padding(
                    ...
                    child: Text(" P2P trader ", style: TextStyle(fontSize: 21,color: Colors.white, fontWeight: FontWeight.w800),),
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: TextFormField(
                  validator: (val) => myController.text == '' || double.parse(myController.text) < 50 ? ' Enter an amount greater than \$50' : null,
                  ...
                  decoration: textinputdecoration.copyWith(
                      ...
                      label: const Text('Price', style: TextStyle(fontWeight: FontWeight.w300, fontSize: 20)
                      ),
              ...
              Padding(
                padding: EdgeInsets.all(10),
                child: TextFormField(
                  validator: (val) => selectedcurrency == '' ? ' Enter a currency' : null,
                  onTap: (){
                    showCurrencyPicker(
                      context: context,
                      showFlag: true,
              ...
              Padding(
                ...
                child: DropDownTextField(
                  ...
                  enableSearch: true,
                  validator: (val) => selectedbank.name == '' ? ' Enter a currency' : null,
                  dropDownList: list,
              ...
              TextButton(
                ...
                selectedbank = const DropDownValueModel(name: '', value: 'value0');
                myController.text = '';
                selectedcurrency = '';
                print(traderdata);
              });
